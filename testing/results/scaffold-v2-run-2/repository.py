"""Cosmos DB data access layer for scores."""
from azure.cosmos.aio import ContainerProxy
from azure.cosmos.exceptions import CosmosResourceNotFoundError


class ScoreRepository:
    """Repository for the scores container."""
    ...
    async def get_player_score(self, player_id: str) -> dict | None:
        """Get player's best score. CROSS-PARTITION: player lookup across regions."""
    ...
    async def get_player_rank(self, score: int) -> int:
        """Get global rank for a score. CROSS-PARTITION: counting higher scores globally."""
