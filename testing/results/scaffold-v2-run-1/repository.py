"""Cosmos DB repository for score data access."""
...
class ScoreRepository:
    ...
    async def get_player_score(self, player_id: str) -> dict | None:
        """Get a player's score. CROSS-PARTITION: player lookup by playerId across regions."""
    ...
    async def get_player_rank(self, score: int) -> int:
        """Get rank for a given score. CROSS-PARTITION: counting all higher scores."""
