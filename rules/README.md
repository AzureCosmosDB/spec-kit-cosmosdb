...
The cosmos-intent-sdk references **111 best-practice rules** organized across **12 categories**, sourced from the [cosmosdb-agent-kit](https://github.com/AzureCosmosDB/cosmosdb-agent-kit). These rules encode domain expertise that constrains AI-generated output to produce architecturally sound Cosmos DB solutions.
